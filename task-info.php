              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <textarea name="task_description" id="task_description" placeholder="Enter Text Description" class="form-control" rows="5" cols="5"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <?php 
                if($user_role == 1){
                  ...
                  <?php
                        ...
                        if(strtotime(date("Y-m-d H:i:s"))>strtotime($row['t_end_time']) && $row['status'] !=2){
                          $style="background-color: #db3636;";
                        }elseif(strtotime($row['time_completed']) > strtotime($row['t_end_time']) &&  $row['status'] ==2 ){
                          $style="background-color: #f5a40a;";
                          }else{
                          $style="";
                ...
                <tr style="<?=$style?>">
                  ...
                  <td>     
                    ...
                    <?php  if($row['status'] == 1){
                     ...
                     <?php /* if($row['status'] == 1){
                        echo $row['t_end_time']== (Strtotime(date("Y-m-d H:i:s")));
                    }*/ ?>
